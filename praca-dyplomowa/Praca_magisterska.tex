...
\begin{figure}[!tbp]
\noindent\fbox{\begin{minipage}{15em}
Dane wejściowe: przykładowe obrazy $(x_{1}, y_{1}), ..., (x_{n}, y_{n})$, gdzie $y_{i}$-ty element jest równy 1 (przykład pozytywny) lub 0 (przykład negatywny)
