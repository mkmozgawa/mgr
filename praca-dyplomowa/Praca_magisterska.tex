...
W celu przyspieszenia wyliczeń wartości cech Haara używa się pośredniej formy obrazu, czyli tzw. obrazu integralnego (ang. \textit{integral image}). Jego wartość w pozycji o współrzędnych \textit{x, y} zawiera sumę pikseli ponad i na lewo od \textit{x, y}, włącznie z samymi \textit{x, y}:
\begin{align}
